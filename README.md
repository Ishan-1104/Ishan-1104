...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0e75b6,100:181717&height=220&section=header&text=Ishan%20Chhaparwal&fontSize=48&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI/ML%20%26%20Full-Stack%20(MERN)%20Developer&descAlignY=58&descSize=18" alt="header banner"/>

<a href="https://www.linkedin.com/in/ishan-chhaparwal/">
  <img src="https://readme-typing-svg.demolab.com/?lines=Final-Year+Computer+Engineering+Student;AI+%2F+ML+%26+GenAI+Builder;Full-Stack+MERN+Developer;Shipping+real+products%2C+not+just+notebooks;Based+in+Pune%2C+India&font=Fira+Code&center=true&width=650&height=45&color=0e75b6&vCenter=true&size=22" alt="Typing SVG" />
</a>
...
> This snake eats through my GitHub contribution graph. It's generated automatically every day by a GitHub Action — see the **[Setup](#-setting-up-the-contribution-snake)** section below to get it running on your own profile repo.
...
A multi-agent research pipeline that takes any topic and automatically **searches the web, scrapes full content, drafts a structured report, and critiques its own output** — orchestrated end-to-end with LangChain.

- **Pipeline:** Search Agent (Tavily + Mistral tool-calling) → Scraper (BeautifulSoup, with URL fallback) → Writer Chain (900–1200 word report) → Critic Chain (self-scored feedback)
- Live Streamlit UI with real-time stage tracking, run history, and Markdown export
...
<img height="165" src="https://github-readme-streak-stats.herokuapp.com/?user=Ishan-1104&theme=tokyonight&hide_border=true" alt="Ishan's GitHub streak" />

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Ishan-1104&layout=compact&theme=tokyonight&hide_border=true" alt="Top languages" />

<img src="https://github-readme-activity-graph.vercel.app/graph?username=Ishan-1104&theme=tokyo-night&hide_border=true" alt="Activity graph" width="100%"/>
...
The animated snake above is generated by the **[Platane/snk](https://github.com/Platane/snk)** GitHub Action. It's not something that renders on its own from just markdown — you need to add a small workflow to this repo once, and GitHub will regenerate the animation daily. Steps:

1. In this repo, create the file `.github/workflows/snake.yml` and paste in the workflow from the file included alongside this README (`snake.yml`).
2. Go to **Settings → Actions → General → Workflow permissions** in this repo and enable **"Read and write permissions"** (the action needs to push the generated SVG to an `output` branch).
3. Commit the workflow file. It will run automatically on a daily schedule, and you can also trigger it manually from the **Actions** tab the first time.
4. Once it runs once, an `output` branch will appear with the generated SVGs, and the snake image in this README will start rendering.

<br/>

<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:181717,100:0e75b6&height=120&section=footer" alt="footer banner"/>
